...
[source, lense]
----
let n = 4; // infers type of n value t be Natural
let r = 5.6; // infers type of r value to be Rational
...
let a : Rational = 10; // reads 10 as Natural, then promotes it to Rational

let half = 1/ 2; // dividing any Whole number by another Whole number results in a Rational
...
let name = "John"; //infers type of value name to be a String
----
